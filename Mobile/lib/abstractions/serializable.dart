...
/// Abstract class to implement "toJson" and "fromJson"
abstract class Serializable<T> {
  /// Function to convert this [Serializable] class into a JSON object
  Map<String, dynamic> toJson();

  /// Function to convert this [Serializable] class from a JSON object and return the class itself

...
class NewsArticle {
  ...
  /// The user's username who made that specific article
  String author;

  /// The UUID of the article
  String uuid;

  /// Construct a new instance of [NewsArticle]
  NewsArticle({ String date, String content, String author, String uuid }) {
